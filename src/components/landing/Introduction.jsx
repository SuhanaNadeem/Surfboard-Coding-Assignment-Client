      ...
      <div className="flex w-full md:w-1/2 flex-col text-center md:text-left">
        ...
        <div className="flex w-full md:flex-row flex-col items-center justify-center md:items-start md:justify-start">
          ...
          <a
            ...
            className="md:mr-4 mb-4 md:my-0 w-full md:w-1/2 border-2 border-red-800 px-4 py-2 uppercase text-red-800 rounded-lg  hover:shadow-md hover:bg-red-800 hover:text-white tracking-wide text-lg md:text-md font-semibold text-center items-center justify-center flex focus:outline-none focus:ring "
          >
            Mentors
          </a>
          <a
            ...
            className=" w-full md:w-1/2 border-2 border-red-800 px-4 py-2 uppercase text-red-800 rounded-lg  hover:shadow-md hover:bg-red-800 hover:text-white tracking-wide text-lg md:text-md font-semibold text-center items-center justify-center flex focus:outline-none focus:ring "
          >
            Students
          </a>
        </div>

    ...
    >
      ...
      <div className="flex flex-col mt-2">
        ...
        <div className="text-right md:text-sm mx-auto mt-4 flex w-1/4 md:w-1/6">
          <button
            type="submit"
            className="flex focus:outline-none focus:ring border-2 mx-auto border-red-800 px-4 py-2 uppercase text-red-800 rounded-lg  hover:shadow-md hover:bg-red-800 hover:text-white tracking-wide text-sm items-center justify-center font-semibold w-full"
          >
            Save
          </button>
        </div>

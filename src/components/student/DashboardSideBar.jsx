...
export default function DashboardSideBar({ props }) {
  ...
  return (
    <nav className="flex md:flex-shrink-0 items-center md:items-start justify-start md:max-w-2xl xl:max-w-5xl border-gray-300 border-b-2 md:border-b-0 md:border-r-2 text-left md:flex-col static md:mt-6 md:w-1/6 my-2 w-full cursor-default z-20 mb-2 md:mb-none pb-3 md:pb-none md:pr-2 overflow-x-hidden">
